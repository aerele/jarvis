"""Copy the legacy watermark column into the renamed agent_seq_watermark column.

The snapshot-recovery watermark field was renamed to agent_seq_watermark (white-label). Frappe model-sync ADDS the new column
...
stale one. The legacy watermark column is RETAINED this release as the
