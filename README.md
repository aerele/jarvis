...
This branch supports Frappe 15. For Frappe 16, use the `version-16` branch.
...
```bash
bench get-app https://github.com/aerele/jarvis.git --branch version-15
...
1. Open **Bench Group > Apps**, choose **Add App**, and add
   `https://github.com/aerele/jarvis.git` from the `version-15` branch.
