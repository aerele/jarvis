...
# PRIMARY/creation/modified plus the pre-existing search_index columns, and
# owner_creation_index appeared the instant the doctype was reloaded.
#
...
DOCTYPES = ("jarvis_macro_run", "jarvis_macro")
