...
def assemble_prompt(
	...
	*,
	...
	from jarvis.chat.custom_skills import armed_skill_clause, invoked_skill_clause, learned_skill_clause
	...
	armed_skill_run_clause = (
		...
		else armed_skill_clause(msg_row.get("content") or "", chat_user)
	)
