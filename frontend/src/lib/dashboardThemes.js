...
const VARS = (v) => `:root{
--jd-bg:${v.bg};--jd-surface:${v.surface};--jd-surface-2:${v.surface2};--jd-ink:${
	v.ink
};--jd-heading:${v.heading || v.ink};--jd-muted:${v.muted};
--jd-line:${v.line};--jd-accent:${v.accent};
--jd-positive:${v.positive};--jd-negative:${v.negative};--jd-warning:${v.warning};--jd-info:${
	v.info
};
