"""Drop legacy bench-side OAuth fields (now owned by the agent inside the container).

REV-1 of the agent subscription work moves OAuth credential state into
the container's auth-profiles.json - the agent refreshes tokens internally
